 ...
 *
 * @see https://github.com/AsyncHttpClient/async-http-client/blob/2.0/client/src/main/java/org/asynchttpclient/ws
 * /WebSocket.java
 */
public class WebSocketClient {
	...
	public CompletableFuture<WebSocket> call(String url, String origin, WebSocketTextListener listener) {
	...
	static class LoggingListener implements WebSocketTextListener {
		...
		public void onOpen(WebSocket webSocket) {
			logger.info("Open the WebSocket");
			webSocket.sendMessage("hello");
		}

		public void onClose(WebSocket webSocket) {
			logger.info("Close the WebSocket");
		}
